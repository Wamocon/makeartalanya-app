        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-[var(--pink-light)] flex items-center justify-center flex-shrink-0">
                  <svg aria-hidden="true" className="w-5 h-5 text-[var(--pink-dark)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <a
                    href="mailto:makeartstudio.tr@gmail.com"
                    className="text-sm text-[var(--pink-dark)] hover:underline font-medium"
                  >
                    makeartstudio.tr@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-[var(--blue-light)] flex items-center justify-center flex-shrink-0">
                  <svg aria-hidden="true" className="w-5 h-5 text-[var(--blue-dark)]" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.198.297-.767.966-.94 1.164-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.372-.01-.57-.01-.198 0-.52.075-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.981.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.002-5.45 4.436-9.884 9.891-9.884a9.82 9.82 0 0 1 7.021 2.91 9.83 9.83 0 0 1 2.9 7.025c-.002 5.45-4.436 9.884-9.928 9.884m8.413-18.297A11.82 11.82 0 0 0 12.055 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.9 11.9 0 0 0 5.689 1.448h.005c6.557 0 11.893-5.335 11.896-11.893a11.82 11.82 0 0 0-3.488-8.413Z" />
                  </svg>
                </div>
                <div>
                  <a
                    href={`https://wa.me/905516745515?text=${encodeURIComponent(t.location.whatsappMessage)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label={`${t.location.whatsappLabel}: ${t.location.phone}`}
