        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[#F0E8EB] bg-slate-50/50">
              <th className="px-5 py-3 text-left text-xs font-semibold text-[#9B8A8F] uppercase tracking-wider">Guest</th>
              <th className="px-5 py-3 text-left text-xs font-semibold text-[#9B8A8F] uppercase tracking-wider">Phone</th>
              <th className="px-5 py-3 text-left text-xs font-semibold text-[#9B8A8F] uppercase tracking-wider">Status</th>
              <th className="px-5 py-3 text-right text-xs font-semibold text-[#9B8A8F] uppercase tracking-wider">Actions</th>
            </tr>
          </thead>
