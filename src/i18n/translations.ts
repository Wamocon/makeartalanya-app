...
export const translations = {
  tr: {
    ...
    booking: {
      ...
      consent: "Kişisel verilerimin rezervasyon ve iletişim amacıyla KVKK kapsamında işlenmesini onaylıyorum.",
  ...
  en: {
    ...
    booking: {
      ...
      consent: "I consent to the processing of my personal data for this booking request and contact under KVKK.",
  ...
  ru: {
    ...
    booking: {
      ...
      consent: "Я согласен(на) на обработку персональных данных для этой заявки и связи в соответствии с KVKK.",
